...
ALLOWED_HOSTS = ["localhost", "ec2-52-91-15-45.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-3-82-146-227.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-3-89-254-246.compute-1.amazonaws.com"

...
ALLOWED_HOSTS = ["localhost", "ec2-54-226-91-17.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-44-222-211-65.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-54-175-234-120.compute-1.amazonaws.com"

...
ALLOWED_HOSTS = ["localhost", "ec2-54-91-67-81.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-54-89-186-75.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-54-196-223-127.compute-1.amazonaws.com"

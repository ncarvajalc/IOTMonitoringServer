...
ALLOWED_HOSTS = ["localhost", "ec2-54-172-54-162.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-44-204-50-99.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-52-87-148-188.compute-1.amazonaws.com"
